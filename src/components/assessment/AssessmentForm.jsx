...
import { YesNoQuestion } from "../common/form/questionTypes/YesNoQuestion";
...
import { ChoiceQuestion } from "../common/form/questionTypes/ChoiceQuestion";
...
import { FileUploadQuestion } from "../common/form/questionTypes/FileUploadQuestion";
import { AuthorizationQuestion } from "../common/form/questionTypes/AuthorizationQuestion";
import { InfoSidebar } from "../common/form/InfoSidebar";
...
export function AssessmentForm() {
	...
	const isAnswered = () => {
		...
		switch (currentQuestion.type) {
			...
			case QUESTION_TYPES.DEMOGRAPHIC:
				return currentQuestion.fields.filter((field) => field.required).every((field) => answer[field.name]);
			case QUESTION_TYPES.FILE_UPLOAD:
