...
export function CapabilityStatementForm() {
  ...
  const { capabilityStatement, loading, error, fetchCapabilityStatement, saveCapabilityStatement } = useCapabilityStatementStore();
  ...
  const renderStepContent = () => {
    switch (activeStep) {
      ...
      case 1:
        return <CapabilitiesSection value={formData.keyCapabilities} onChange={(value) => updateFormData('keyCapabilities', value)} />;
      case 2:
        return <CompetitiveSection value={formData.competitiveAdvantage} onChange={(value) => updateFormData('competitiveAdvantage', value)} />;
      case 3:
        return (
      ...
      case 4:
        return <PastPerformanceSection value={formData.pastPerformance} onChange={(value) => updateFormData('pastPerformance', value)} />;
      case 5:
        return <CertificationsSection value={formData.certifications} onChange={(value) => updateFormData('certifications', value)} />;
      case 6:
